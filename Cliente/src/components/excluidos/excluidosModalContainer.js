  ...
  render() {
    return (
      ...
      <Row>
        ...
        >
          <Form onRef={ref => (this.form = ref)} visible={this.setmodalVisible} usuario={this.props.usuario} modo={this.props.modo} row={this.props.row} editCaso={this.props.editCaso}  downloadFile={this.props.downloadFile} downloadFile={this.props.downloadFile} deleteFiles={this.props.deleteFiles}/>
        </Modal>
      </Row>
      <Row>
      <Modal
