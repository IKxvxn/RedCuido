  ...
  render() {
    return (
      ...
      <Row>
        ...
        >
          <Form visible={this.setmodalVisible} usuario={this.props.usuario} onRef={ref => (this.form = ref)}  modo={this.props.modo} row={this.props.row} editCaso={this.props.editCaso} deleteFiles={this.props.deleteFiles}/>
        </Modal>
      </Row>
      <Row>
      <Modal
